export const puroks = ['Purok 1A', 'Purok 1B', 'Purok 2A & 2B', 'Purok 3A', 'Purok 3B', 'Purok 4', 'Purok 5A', 'Purok 5B', 'Purok 6', 'Purok 7', 'Purok 8']
...
const rawRecords: PatientRecord[] = [
  ...
  { id: 'PTN-2610205', purok: 'Purok 2A & 2B', date: '03-27-2026', deceased: false, form: { ...emptyForm, lastName: 'Santos', givenName: 'Judith', middleName: 'A.', sex: 'Female', street: 'Purok 2A & 2B' }, immunizationRecords: [], medicalRecords: [] },
  ...
  { id: 'PTN-0001003', purok: 'Purok 2A & 2B', date: '04-01-2026', deceased: false, form: { ...emptyForm, lastName: 'Patient', givenName: 'Three', middleName: '', sex: 'Male', street: 'Purok 2A & 2B' }, immunizationRecords: [], medicalRecords: [] },
