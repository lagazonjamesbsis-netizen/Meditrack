...
const PHILIPPINE_IDS = [
  ...
  { name: 'UMID / Unified Multi-Purpose ID', note: 'SSS Â· GSIS' },
        ...
        <div className="flex flex-col gap-2.5">
          {assessing && (
            <div className="flex items-center justify-center gap-2.5 py-9 rounded-2xl bg-mist/50">
              ...
              <span className="text-[13px] text-slate">Checking photo clarityâ€¦</span>
            </div>
          )}
          ...
          {!assessing && photo && (
            <div className="flex flex-col gap-2.5">
              ...
              <div className="flex gap-2.5">
                ...
                {secondaryAction(/* eslint-disable-next-line react-hooks/refs */
                  () => {
                    replacePhoto()
                    void startCamera()
                  },
