    ...
    <>
      <div className={`flex items-center justify-between pl-7 pr-0 py-5 ${darkMode ? "bg-[rgba(45,27,78,0.65)]" : "bg-white/65"}`}>
        ...
        <div className="flex items-center gap-3 text-[18px] text-[#5a6b76] pr-4">
          ...
          <div className="w-9 h-9 rounded-full bg-[#2ea3e6] text-white flex items-center justify-center font-bold text-sm overflow-hidden">
            <UserRound size={20} />
          </div>
        </div>
      </div>
      ...
      <div className={`flex-1 ${darkMode ? "bg-[#050617]/40" : ""}`}>
        <div className="px-12 pt-5 pb-12">
          <div className="mb-7 flex flex-wrap items-end justify-between gap-4">
            <div>
              <p className={`mb-1 font-poppins text-sm font-bold uppercase tracking-[0.18em] ${darkMode ? "text-cyan-400" : "text-cyan-600"}`}>
                Admin insights
              </p>
              <h1 className={`font-poppins text-[45px] font-extrabold tracking-tight ${darkMode ? "text-[#F9FAFB]" : "text-[#286486]"} leading-none`}>
                Analytics
              </h1>
            </div>
            <div className="relative">
              ...
              {periodOpen && (
                <>
                  ...
                  <div className={`absolute right-0 top-full mt-1 z-20 rounded-lg border shadow-lg overflow-hidden ${darkMode ? "bg-[#050617] border-gray-700" : "bg-white border-slate-300"}`}>
                    {periods.map((p) => (
                      <button
                        key={p}
          ...
          <section className="grid gap-5 xl:grid-cols-2">
            <div className={`${darkMode ? "bg-[rgba(45,27,78,0.65)] border-[rgba(255,255,255,0.10)]" : "bg-white/65 border-[rgba(15,60,95,0.08)]"} border p-5 rounded-[24px] shadow-[0_4px_6px_-1px_rgba(0,0,0,0.06)]`}>
              <h2 className={`mb-5 font-poppins text-lg font-extrabold ${darkMode ? "text-[#F9FAFB]" : "text-slate-700"}`}>Top Health Concerns</h2>
            ...
            <div className={`${darkMode ? "bg-[rgba(45,27,78,0.65)] border-[rgba(255,255,255,0.10)]" : "bg-white/65 border-[rgba(15,60,95,0.08)]"} border p-5 rounded-[24px] shadow-[0_4px_6px_-1px_rgba(0,0,0,0.06)]`}>
              <h2 className={`mb-5 font-poppins text-lg font-extrabold ${darkMode ? "text-[#F9FAFB]" : "text-slate-700"}`}>Appointment Statistics</h2>
            ...
            <div className={`${darkMode ? "bg-[rgba(45,27,78,0.65)] border-[rgba(255,255,255,0.10)]" : "bg-white/65 border-[rgba(15,60,95,0.08)]"} border p-5 rounded-[24px] shadow-[0_4px_6px_-1px_rgba(0,0,0,0.06)]`}>
              <h2 className={`mb-5 font-poppins text-lg font-extrabold ${darkMode ? "text-[#F9FAFB]" : "text-slate-700"}`}>Consultation Types</h2>
            ...
            <div className={`${darkMode ? "bg-[rgba(45,27,78,0.65)] border-[rgba(255,255,255,0.10)]" : "bg-white/65 border-[rgba(15,60,95,0.08)]"} border p-5 rounded-[24px] shadow-[0_4px_6px_-1px_rgba(0,0,0,0.06)]`}>
              <h2 className={`mb-5 font-poppins text-lg font-extrabold ${darkMode ? "text-[#F9FAFB]" : "text-slate-700"}`}>Patients Demographics</h2>
              <div className="flex items-center justify-around gap-5">
                <div className="space-y-3 text-[13px] text-slate-500">
          ...
          <div className={`mt-5 ${darkMode ? "bg-[rgba(45,27,78,0.65)] border-[rgba(255,255,255,0.10)]" : "bg-white/65 border-[rgba(15,60,95,0.08)]"} border p-5 rounded-[24px] shadow-[0_4px_6px_-1px_rgba(0,0,0,0.06)]`}>
            <h2 className={`mb-4 font-poppins text-lg font-extrabold ${darkMode ? "text-[#F9FAFB]" : "text-slate-700"}`}>Insights & Alerts</h2>
